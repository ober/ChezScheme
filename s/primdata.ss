...
(define-symbol-flags* ([libraries (rnrs) (rnrs hashtables)] [flags primitive proc])
  ...
  (hashtable-ref [sig [(hashtable ptr ptr) -> (ptr)]] [flags discard cptypes2])
  (hashtable-set! [sig [(hashtable ptr ptr) -> (void)]] [flags true cptypes2])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (make-ordered-hashtable [sig [(procedure procedure) -> (ordered-hashtable)]] [flags alloc])
  (ordered-hashtable? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (ordered-hashtable-size [sig [(ordered-hashtable) -> (uint)]] [flags discard])
  (ordered-hashtable-ref [sig [(ordered-hashtable ptr ptr) -> (ptr)]] [flags discard])
  (ordered-hashtable-contains? [sig [(ordered-hashtable ptr) -> (boolean)]] [flags discard])
  (ordered-hashtable-set! [sig [(ordered-hashtable ptr ptr) -> (void)]] [flags true])
  (ordered-hashtable-delete! [sig [(ordered-hashtable ptr) -> (void)]] [flags true])
  (ordered-hashtable-update! [sig [(ordered-hashtable ptr procedure ptr) -> (void)]] [flags true])
  (ordered-hashtable-clear! [sig [(ordered-hashtable) -> (void)]] [flags true])
  (ordered-hashtable-keys [sig [(ordered-hashtable) -> (vector)]] [flags alloc])
  (ordered-hashtable-values [sig [(ordered-hashtable) -> (vector)]] [flags alloc])
  (ordered-hashtable-entries [sig [(ordered-hashtable) -> (vector vector)]] [flags discard])
  (ordered-hashtable-cells [sig [(ordered-hashtable) -> (vector)]] [flags alloc])
  (ordered-hashtable-copy [sig [(ordered-hashtable) -> (ordered-hashtable)]] [flags alloc])
  (ordered-hashtable-walk [sig [(ordered-hashtable procedure) -> (void)]] [flags])
  (ordered-hashtable-equivalence-function [sig [(ordered-hashtable) -> (procedure)]] [flags pure discard])
  (ordered-hashtable-hash-function [sig [(ordered-hashtable) -> (procedure)]] [flags pure discard])
  (record-walk [sig [(record) -> (vector)]] [flags alloc])
  (record-fields [sig [(record) -> (vector)]] [flags alloc])
  (record->alist [sig [(record) -> (list)]] [flags alloc])
